...
```{r prepare-hmw-debugging-1, echo=FALSE}
...
```{r debugging_hmw2, exercise = TRUE, exercise.blanks = "___+", exercise.completion = FALSE, exercise.setup = "prepare-hmw-debugging-1"}
...
```{r debugging_hmw3, exercise = TRUE, exercise.completion = FALSE, exercise.setup = "prepare-hmw-debugging-1"}
