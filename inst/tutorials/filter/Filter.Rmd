...
farm_data <- read_csv(here::here("inst","tutorials","SharedResources","datasets","FarmInventory","data.csv"), col_types="ccddffi");
...
shiny::addResourcePath("SharedResources", here::here("inst","tutorials","SharedResources"))#Needed for accessing images/other files
...
```{r, child=here::here("inst","tutorials","SharedResources","datasets","PalmerPenguins","description.Rmd")}
...
```{r include_hmw_grader, child=here::here("inst","tutorials","SharedResources","grading","hmw_grader.Rmd")}
```
```{r include_hmw_dwnld, child=here::here("inst","tutorials","SharedResources","grading","download_homework.Rmd")}
```
...
```{r  child=here::here("inst","tutorials","SharedResources","datasets","FarmInventory","description.Rmd")}
```
