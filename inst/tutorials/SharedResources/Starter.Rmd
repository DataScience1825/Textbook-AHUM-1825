...
addResourcePath("shared_images", "../SharedResources/images")#Add access to a shared set of images. Like the banner for the farm dataset
farm_data <- read_csv("../SharedResources/datasets/Farm Dataset.csv", col_types="ccddffi"); #Homework dataset
...
![Cartoon showing a round monster holding up a sign that says dplyr::_starter_”](images/Blank Banner.png){width=100%} 
