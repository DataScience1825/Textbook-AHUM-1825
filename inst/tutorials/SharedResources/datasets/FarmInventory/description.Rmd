...
![A banner with a centered message of Farming Dataset, on the left are a collection of vegetables, and on the right is a milk can and a hen with its chicks ](SharedResources/datasets/FarmInventory/banner.jpg){width=100%} 
...
<!--
```{r, include=FALSE}
farm_data <- read_csv("data.csv", col_types="ccddffi"); ##Homework Dataset
```
