![Palmer Penguins, showing drawings of the Chinstrap (left), Gentoo (center), and Adélie (right) penguins](SharedResources/datasets/PalmerPenguins/banner.png){width=100%} 
