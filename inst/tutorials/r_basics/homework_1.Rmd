...
```{r prepare-hmw-r_basics-1, echo=FALSE}
...
#### Problem 1
```{r r_basics_hmw1, echo=FALSE, exercise.startover = TRUE}
...
```{r r_basics_hmw2, exercise = TRUE, exercise.blanks = "___+", exercise.completion = FALSE, exercise.setup = "prepare-hmw-r_basics-1"}
complete code ____ by filling ____ in blanks _____ 
```

```{r r_basics_hmw2-check}
grade_result(
...
```{r r_basics_hmw3, exercise = TRUE, exercise.completion = FALSE, exercise.setup = "prepare-hmw-r_basics-1"}

```  

```{r r_basics_hmw3-check}
grade_result(
  pass_if(~identical(.result, TRUE))#Replace TRUE with the solution's code
)
```
