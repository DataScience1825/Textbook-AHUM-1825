...
shiny::addResourcePath("www", "www")#Needed for accessing local images & css
...
![Cartoon showing a round monster holding up a sign that says dplyr::select”](www/images/tutorial_banner.png){width=100%} 
...
<img  src="www/images/rename_sm.jpg" alt="A mouse changing data frames variable (column) names to 'nemesis' and 'lair' from 'species' and 'site', with news of a cheese heist in the background." style="width:80%; margin:0 10%" />
