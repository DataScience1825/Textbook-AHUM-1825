...
green_vehicles <- read_csv("data/hmw_data.csv", col_types="fcddffffcccfdddddcd")
```
...
```{r select_hmw3, exercise = TRUE, exercise.blanks = "___+", exercise.completion = FALSE, exercise.setup="prepare-select-hw1"}
...
```{r select_hmw4, exercise = TRUE, exercise.completion = FALSE, exercise.setup="prepare-select-hw1"}
...
```{r select_hmw5, exercise = TRUE, exercise.completion = FALSE, exercise.setup="prepare-select-hw1"}
...
```{r select_hmw6, exercise = TRUE, exercise.completion = FALSE, exercise.setup="prepare-select-hw1"}
